...
import { InfoIconSvg, ProfitabilityIconsSvg } from "../Icons";

export const CatalogItemFooter = ({ isMobileVersion }) => {
  return (
    <>
      {!isMobileVersion ? (
        ...
        <div className="catalog-item-footer">
          <div className="wrapperPriceAndProfitability">
            <div className="catalog-item-footer-price">
              <div className="textPrice">55,1$</div>
              <InfoIconSvg />
            </div>
